...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(); // i want the app to display MyIntro as it begins and inside the MyIntro,once the user press skip or done
                          //it will redirect him the mainactivity by calling the startLogin method
    }
